...
<body class="bg-default">
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-horizontal navbar-expand-md navbar-dark">
      <div class="container px-4">
        <a class="navbar-brand" href="{{ url('/') }}">
          <img src="{{ asset('img/brand/iepc.png') }}" />
        </a>
    ...
    <!-- Header -->
    <div class="header py-6 py-lg-7" style="background-color: #e90775">
      <div class="container">
  ...
  <!-- Footer -->
  <footer class="py-5" > <!-- si lo pones aqui es para la parte donde dice laravel -->
    <div class="container">
